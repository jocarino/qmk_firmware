...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {          
        ...
        KC_LALT, LGUI(KC_A), LGUI(KC_S), KC_TAB, KC_LGUI, KC_LSFT,               KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, LT(1,KC_QUOT), KC_HASH,
        KC_LCTL, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), KC_LGUI,     KC_NO, KC_HOME, KC_END, KC_PGUP, KC_PGDN, KC_NO,
